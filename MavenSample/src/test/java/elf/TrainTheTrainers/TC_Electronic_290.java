...
public class TC_Electronic_290 extends BaseTest {

	String computerHardDrivePageTitle="ShoppersStack | Home";
	...
	public void toClickCameraTab() throws InterruptedException {
		...
		Thread.sleep(2000);
		ele.getComputer().click();
		//wait.until(ExpectedConditions.titleContains("Electronics"));
		Assert.assertEquals(driver.getTitle(), computerHardDrivePageTitle, "Computer hard drive page is not displayed");
		Reporter.log("Computer hard drive page is displayed",true);
	}
